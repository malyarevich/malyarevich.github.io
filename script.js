      ...
      })(
        {
            ...
            function (t, e, n) {
              ...
              if (w[v] && b.xhrWrappable) {
                ...
                j.on(u, r),
                  ...
                  T.buffer([u, "new-xhr", "send-xhr" + c]),
                  R.buffer([m + c, m + "-done", m + f + c, m + f + s]),
                  E.buffer(["newURL"]),
                  g.buffer([u]),
                  x.buffer([
                    "propagate",
          ...
          9: [
            function (t, e, n) {
              ...
              if (((e.exports = s), o())) {
                ...
                f.inPlace(HTMLElement.prototype, h, "dom-"),
                  f.inPlace(HTMLHeadElement.prototype, h, "dom-"),
                  f.inPlace(HTMLBodyElement.prototype, h, "dom-"),
          ...
          14: [
            function (t, e, n) {
              ...
              function i(t) {
                b.push(t),
                  l && (x ? x.then(a) : v ? v(a) : ((E = -E), (P.data = E)));
              }
              function a() {
              ...
              if (
                ...
                if (!v && !m) {
                  ...
                  new l(a).observe(P, { characterData: !0 });
                }
              } else
              ...
              if (a.xhrWrappable) {
                ...
                (a.features.xhr = !0),
                  ...
                  f.on("send-xhr-start", function (t, e) {
                    ...
                    for (var c = 0; c < d; c++)
                      e.addEventListener(u[c], this.listener, !1);
                  }),
                    ...
                    function () {
                      if (
                        ...
                        try {
                          ...
                          throw (
                            (s.emit("fn-err", [arguments, this, t], n), t)
                          );
                        } finally {
              ...
              function o(t) {
                ...
                function n(n, r, o, i) {
                  if (!p.aborted || i) {
                    t && t(n, r, o);
                    for (
                      var a = e(o), c = l(n), s = c.length, f = 0;
                      f < s;
                      f++
                    )
                      c[f].apply(a, r);
            ...
            function (t, e, n) {
              ...
              t(17),
                p[h]
                  ...
                  : (p[l]("onreadystatechange", o), d[l]("onload", r)),
    ...
    NREUM.info = {
      beacon: "bam.nr-data.net",
      errorBeacon: "bam.nr-data.net",
      licenseKey: "a67936c515",
      applicationID: "77322204",
      sa: 1,
    };